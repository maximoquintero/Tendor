...
export default function Historial() {
  return (
    ...
    <div className='bg-[#EEF1F9] dark:bg-[#1F1F1F] h-full w-full p-10 bottom-0'>
      <div children='h-full'>
      <Navbar/>
      <div className='h-full flex gap-28 items-center mx-20 my-14 '>
     ...
     <button className='border-[2px] rounded-2xl border-[#A5A5FD] w-[50%] h-4 py-4 bg-gray-50 dark:bg-[#1F1F1F] dark:border-[#858585]'>
      ...
      <h1 className='p-2 pt-0 font-semibold'> HOLA </h1>
